...
router.get('/', authenticateToken, validateQuery(UserQuerySchema), async (req, res) => {
  try {
...
router.get('/:id', authenticateToken, validateParams(UserIdSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/', authenticateToken, validateBody(CreateUserSchema), async (req, res) => {
  try {
...
router.delete('/:id', authenticateToken, validateParams(UserIdSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.get('/email/:email', authenticateToken, validateParams(UserEmailSchema), async (req, res) => {
  try {
