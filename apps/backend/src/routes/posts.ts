...
router.get('/', authenticateToken, validateQuery(PostQuerySchema), async (req, res) => {
  try {
...
router.get('/:id', authenticateToken, validateParams(PostIdSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/', authenticateToken, validateBody(CreatePostSchema), async (req, res) => {
  try {
...
router.delete('/:id', authenticateToken, validateParams(PostIdSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.patch('/:id/toggle-publish', authenticateToken, validateParams(PostIdSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.get('/author/:authorId', authenticateToken, validateParams(AuthorIdSchema), async (req, res) => {
  try {
