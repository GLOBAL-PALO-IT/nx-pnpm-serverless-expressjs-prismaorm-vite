...
import type { LoginData, RegisterData } from '@nx-serverless/types';
...
// Logger interface (to be provided by consumer)
interface Logger {
...
export class AuthService {
  ...
  public async logout(refreshToken: string): Promise<void> {
    try {
      ...
      this.logger.info(`User logged out successfully: ${decoded.email}`);
    } catch (error) {
